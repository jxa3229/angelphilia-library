引用链接：[Yamato VMF50 Original Concept Image Girl #2 RISA](https://myfigurecollection.net/entry/32014)

## 译文（日译中）

# Yamato VMF50 Original Concept Image Girl #2 RISA
...
查询说明：早期 YAMATO VMF50 记录；以编号和名称作为稳定检索入口。
联动说明：前史入口。
...
検索メモ：早期YAMATO VMF50の記録。番号と名前を検索キーとして保留。
連動メモ：前史入口。
