...
- UI、JSON、spec 和复制内容不写具体网站、平台、链接、作者或截图来源。
- 用户可见来源统一显示“网络数据”。
...
7. 来源面板只显示“网络数据”、误差或“待补充”。
8. 一键复制默认输出 `Body GHH / default Obitsu frame+arms+shins+hands+feet / no head data`。
9. 插入 M 头后复制摘要追加 `head M / head girth 17.4cm / eye 12/6,14/6,14/7`。
